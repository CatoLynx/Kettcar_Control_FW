...
#define BRAKE_LIGHT_DECEL_THRESHOLD -8  // Deceleration threshold for brake light activation
...
#define BRAKE_LIGHT_MIN_SPEED 60  // Minimum speed for automatic brake light activation
#define MODE_CHANGE_MAX_SPEED 40  // Maximum speed for control mode change
...
#define OUTPUT_POS_IND_IGNITION 14
